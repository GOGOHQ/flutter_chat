...
import 'dart:io';
import 'dart:math';
import 'package:flutter_chat/Model/xFVoiceConvertModel.dart';
...
class XFVoiceProvider with ChangeNotifier {
  ...
  converTextToVoice(String appid, String player, String text) {
    ...
    channelTTV.sink.add(jsonString);
    notifyListeners();
  }
  ...
  String genChannelToken(String url) {
    ...
    String apiSecret = "78047831e201620f3871753cb712698d";
    String apiKey = "f485c49db33633b6b2f099ea0f74bd06";

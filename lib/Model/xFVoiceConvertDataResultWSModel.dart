import 'package:flutter_chat/Model/xFVoiceConvertDataResultWSCWModel.dart';
...
class XFVoiceConvertDataResultWSModel {
  int bg;
  List<XFVoiceConvertDataResultWSCWModel> cw =
      List<XFVoiceConvertDataResultWSCWModel>();
  ...
  Map<String, dynamic> toJson() =>
      _$XFVoiceConvertDataResultWSModelToJson(this);
}
